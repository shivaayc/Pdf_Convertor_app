...
import pdf.dudepdftools.activity.FavouritesActivity;
...
import static pdf.dudepdftools.util.Constants.ADD_IMAGES_KEY;
import static pdf.dudepdftools.util.Constants.ADD_PASSWORD_KEY;
import static pdf.dudepdftools.util.Constants.ADD_PWD;
import static pdf.dudepdftools.util.Constants.ADD_TEXT_KEY;
...
import static pdf.dudepdftools.util.Constants.COMPRESS_PDF_KEY;
import static pdf.dudepdftools.util.Constants.EXCEL_TO_PDF_KEY;
import static pdf.dudepdftools.util.Constants.EXTRACT_IMAGES;
import static pdf.dudepdftools.util.Constants.EXTRACT_IMAGES_KEY;
import static pdf.dudepdftools.util.Constants.EXTRACT_TEXT_KEY;
import static pdf.dudepdftools.util.Constants.HISTORY_KEY;
import static pdf.dudepdftools.util.Constants.IMAGE_TO_PDF_KEY;
import static pdf.dudepdftools.util.Constants.INVERT_PDF_KEY;
import static pdf.dudepdftools.util.Constants.MERGE_PDF_KEY;
import static pdf.dudepdftools.util.Constants.PDF_TO_IMAGES;
import static pdf.dudepdftools.util.Constants.PDF_TO_IMAGES_KEY;
import static pdf.dudepdftools.util.Constants.QR_BARCODE_KEY;
import static pdf.dudepdftools.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static pdf.dudepdftools.util.Constants.REMOVE_PAGES;
import static pdf.dudepdftools.util.Constants.REMOVE_PAGES_KEY;
import static pdf.dudepdftools.util.Constants.REMOVE_PASSWORD_KEY;
import static pdf.dudepdftools.util.Constants.REMOVE_PWd;
import static pdf.dudepdftools.util.Constants.REORDER_PAGES;
import static pdf.dudepdftools.util.Constants.REORDER_PAGES_KEY;
import static pdf.dudepdftools.util.Constants.ROTATE_PAGES;
import static pdf.dudepdftools.util.Constants.ROTATE_PAGES_KEY;
import static pdf.dudepdftools.util.Constants.SPLIT_PDF_KEY;
import static pdf.dudepdftools.util.Constants.TEXT_TO_PDF_KEY;
import static pdf.dudepdftools.util.Constants.VIEW_FILES_KEY;
import static pdf.dudepdftools.util.Constants.ZIP_TO_PDF_KEY;
